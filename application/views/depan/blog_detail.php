                        ...
                        <div class="col-lg-3  col-md-3">
                            <div class="blog_info text-right">
                                <ul class="blog_meta list">
                                    <li><a href="#"><?php echo $author; ?><i class="ti-user"></i></a></li>
                                    <li><a href="#"><?php echo $tanggal; ?><i class="ti-calendar"></i></a></li>
                                    <li><a href="#"><?php echo $kategori; ?><i class="ti-tag"></i></a></li>
                                </ul>
