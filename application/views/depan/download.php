            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="<?= base_url() ?>">
                        <img class="logo-2" src="<?php base_url() ?>assets/img/logo2.png" alt="" />
                    </a>
    ...
    <div class="whole-wrap">
        <div class="container">
            ...
            <div class="section-top-border">
                <h3 class="title_color text-center">Download Dokumen</h3>
                <br><br>
                <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:right;"><a href="<?php echo site_url('download/get_file/' . $row->file_id); ?>" class="genric-btn primary radius">Download</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
