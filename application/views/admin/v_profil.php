                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="visi" class="form-control" value="<?php echo $b['visi']; ?>" placeholder="Visi Sekolah" required />
                                    <label for="">Alamat</label>
                                    <input type="text" name="alamat" class="form-control" value="<?php echo $b['alamat']; ?>" placeholder="Alamat Sekolah" required />
                                    <label for="">Telepon</label>
                                    <input type="text" name="telepon" class="form-control" value="<?php echo $b['telepon']; ?>" placeholder="Telepon Sekolah" required />
                                    <label for="">Email</label>
                                    <input type="text" name="email" class="form-control" value="<?php echo $b['email']; ?>" placeholder="Email Sekolah" required />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                ...
                                <textarea id="ckeditor" name="misi" required><?php echo $b['misi']; ?></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                ...
                                <textarea id="ckeditor1" name="sejarah" required><?php echo $b['sejarah']; ?></textarea>
